...
const correctedAddressDataSchema = new Schema({
...
correctedAddressDataSchema.index({}, { unique: false });

const CorrectedAddressData = mongoose.model('correctAddressData', correctedAddressDataSchema);

export default CorrectedAddressData;